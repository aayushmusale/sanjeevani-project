...
//             {filteredUniversities.map((uni) => (
//               <Link key={uni.slug} href={`/universities/${uni.slug}`}>
//                 <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md hover:border-red-200 transition-all duration-300 h-full flex flex-col justify-between group">
//                   <div>
