...
// ✨ TWEAK 1: Using path alias for cleaner imports
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <section>
                  ...
                  <ul className="space-y-3 text-gray-700 text-lg">
                    {/* ✨ TWEAK 2: Added optional chaining (?) just in case data is missing */}
...
//   // 3. Now slug will be a string, and your find method will work!
//   const university = universityData.find((uni) => uni.slug === slug);
