...
const services: Service[] = [
  ...
  description: 'We provide complete support for student accommodation, including hostel arrangements, local assistance, airport pickup, and a comfortable stay in a new country.',
  icon: Hotel,
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => {
            ...
            return (
              <div
                key={service.id}
                className="group p-16 bg-red-600 text-white border border-red-700 rounded-xl shadow-lg 
                            hover:shadow-2xl hover:-translate-y-2 hover:scale-105 
                            transition-all duration-300 ease-in-out animate-fadeup"
              >
                <div className="flex items-center space-x-4 mb-4">
                  <div className="p-4 bg-white rounded-full text-red-600">
                    <IconComponent className="h-6 w-6 transition-transform duration-300 group-hover:rotate-12" />
                  </div>
